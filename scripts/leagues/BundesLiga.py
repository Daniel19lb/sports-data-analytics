...
#a = sofascore.get_valid_seasons('Spain La Liga')
# print(a)
Liga = sofascore.get_match_dicts('24/25', 'BundesLiga')
# print(Liga)
...
for partido in Liga:
    ...
    if not df_partido.empty:
        ...
        print("partido completado exitosamente..")
# ---------------------------------------------------------------------------------------------------------
...
print("Ahora pondremos todo en Excel......")
df_stats_match.to_excel('BundesLiga.xlsx', index_label='Id Partido', sheet_name='Partidos')
